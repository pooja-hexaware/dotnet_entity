...
{
    public class When_deleting_hexamember : UsingHexaMemberServiceSpec
    {
        ...
        public override void Context()
        {
            ...
            _hexamemberRepository.Delete(Id).Returns(true);
        }
        ...
        {
            _hexamemberRepository.Received(1).Delete(Id);
